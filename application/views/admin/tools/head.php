<base href="<?php echo base_url(); ?>" />
 ...
 <!-- TinyMCE -->
<script src="assets/tinymce/jquery-2.0.2.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      plugins: [
           ...
           "table contextmenu directionality emoticons paste textcolor responsivefilemanager code fullpage"
     ],
     ...
     external_filemanager_path:"http://localhost/Web_Perwakilan/assets/filemanager/",
     filemanager_title:"Media Manager" ,
     external_plugins: { "filemanager" : "http://localhost/Web_Perwakilan/assets/filemanager/plugin.min.js"}
    });
</script>
