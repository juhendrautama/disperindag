...
class Undahan extends CI_Controller {
...

	{
		...
		$data['tampil_data_kat_putusan_id']=$this->M_crud_putusan->tampil_data_kat_putusan_id($id)->row();
		$data['tampil_data_putusan_idkat']=$this->M_crud_putusan->tampil_data_putusan_idkat($id);
