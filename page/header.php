  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">        
        ...
        <li>
            <a class="dropdown-toggle dropdown" type="button" data-toggle="dropdown">Profil
            <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="kepala.php">Sambutan Kepala Badan</a></li>
              <li><a href="sejarah.php">Sejarah Jambi</a></li>
              <li><a href="sekilas.php">Sekilas Jambi</a></li>
              <li><a href="organisasi.php">Struktur Organisasi</a></li> 
              <li><a href="#">Tugas Pokok & Fungsi</a></li>
              <li><a href="visi_misi.php">Misi Visi</a></li>                
            </ul>
        ...
        <li>
            ...
            <a class="dropdown-toggle dropdown" type="button" data-toggle="dropdown">Gallery
            <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="gallery.php">Foto</a></li>
              <li><a href="video.php">Video</a></li>   
              <li><a href="wisata.php">Wisata Jambi</a></li>            
            </ul>
